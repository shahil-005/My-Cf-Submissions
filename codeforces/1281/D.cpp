...
// URL: https://codeforces.com/contest/1281/problem/D
// Memory Limit: 256 MB
// Time Limit: 2000 ms
...
void solve(LL tc)
{
	...
	//If any border edge is full-filled with A: 1
	//If any corner cell has A or any complete row/column has A : 2
	//If any cell has A : 4
	//Else not possible
	// line(30);
}
