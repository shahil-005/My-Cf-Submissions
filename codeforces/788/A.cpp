// Author: shahil_005
// Time: 2021-03-31 05:15:43
// Problem: F. Functions again
// Contest: Codeforces - Practice 1600s March 31
// URL: https://codeforces.com/gym/322372/problem/F
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
void solve(int tc)
{
	...
	for(ll i=1;i<=n;i++){
		...
		cin>>x;
		if(i>1){
			v.pb(abs(x-prev)*pow(-1,(i&1)));
			v2.pb(abs(x-prev)*pow(-1,!(i&1)));
		}
		prev=x;
	}
	 // debug(v);
