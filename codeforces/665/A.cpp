// Author: shahil_005
// Time: 2021-01-31 20:05:12
// Problem: A. Buses Between Cities
// Contest: Codeforces - Educational Codeforces Round 12
// URL: https://codeforces.com/contest/665/problem/A
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
void solve(LL tc)
{
	...
	LL S=( 60*(10*(s[0]-'0')+(s[1]-'0') ) + (10*(s[3]-'0')+(s[4]-'0') ) );
	
	LL X=max(300LL,S-y+1);
	LL Y=min(1439LL,S+x-1);
	// d3(S,X,Y);
	LL i=300;
	LL ans=0;
	while(i<1440){
