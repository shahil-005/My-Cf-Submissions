...
void solve()
{
        ...
        if(n==5){
        	...
        	if(pos==0){
        		...
        		LL ans1=1,ans2=1,ans3=1,ans4=1,ans5=1;
			ans1=a[n-1];
			ans2=a[n-1]*a[n-2];
			ans3=a[n-1]*a[n-2]*a[n-3];
			ans4=a[n-1]*a[n-2]*a[n-3]*a[n-4];
			ans5=a[n-1]*a[n-2]*a[n-3]*a[n-4]*a[n-5];
			fe(i,0,3){
				ans1*=a[i];
			}
			fe(i,0,2){
			...
			fe(i,0,0){
        		...
        		cout<<max(max(ans1,ans3),ans5)<<endl;
