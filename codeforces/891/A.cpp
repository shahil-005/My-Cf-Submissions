// Author: shahil_005
// Time: 2021-04-07 17:03:39
// Problem: I. Pride
// Contest: Codeforces - Practice 1500s (a)
// URL: https://codeforces.com/gym/323308/problem/I
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
{
	//Editorial sol
	//Just brute force through all segments and check if gcd is possible for that segment
	//If yes, try finding the shortest segment as that particular segment will be transversed 2 times
	ll n;
	cin>>n;
	ll a[n+1];
	ll cnt=0;
