...
void solve(LL tc)
{
	...
	// When n is odd:
		...
		// So,we make full use of all the 3 numbers
	// When n is even && n%3!=0:
		// For eg ,n=20
		// We have 3 choices : c1(20 19 18),c2(20 19 17),c3(19 18 17)
		// gcd of pairs in c1 : {1,1,2}
		// gcd of pairs in c2 : {1,1,1}
		// gcd of pairs in c3 : {1,1,1}
		// So c2 & c3 will be > c1 and c2 > c3 :------------So,c2>c3>c1
	// When n is even && n%3==0:
		// For eg ,n=30
		// We have 3 choices : c1(30,29,28),c2(30,29,27),c3(29,28,27)
		// gcd of pairs in c1 : {1,1,2}
		// gcd of pairs in c2 : {1,1,3}
		// gcd of pairs in c3 : {1,1,1}
		// So c3 > c1 > c2
	LL n;
	cin>>n;
