...
const long long N=(long long)(5e3+1);
const long long MOD=(long long)(1e9+7);
const long long INF=(long long)(2e18);
VL adj[N];
bool vis[N];
SL st;	//set to maintain the stack of nodes
set<PLL> back;	//back edges
VPLL edges;
void dfs(LL s){
	vis[s]=true;
	st.insert(s);
...
void solve(LL tc)
{
// https://codeforces.com/blog/entry/69554?#comment-540818
// https://codeforces.com/blog/entry/69554?#comment-540889
// https://codeforces.com/blog/entry/69554?#comment-540936 (If undircted graph)
// https://codeforces.com/blog/entry/69554?#comment-541037 (greedy sol)
	...
	each(it,edges){
		if(back.find({it.ff,it.ss})!=back.end()){
			cout<<2<<" ";
		}
		else{
			cout<<1<<" ";
	...
	//We just need to find the back edges
	//so k will always be either 1 or 2 
	//all back edges will be colored same
}
int main()
{
// #ifndef ONLINE_JUDGE
