// Author: shahil_005
// Time: 2021-04-07 17:03:53
// Problem: M. Kyoya and Colored Balls
// Contest: Codeforces - Practice 1500s (a)
// URL: https://codeforces.com/gym/323308/problem/M
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
void solve(int tc)
{
	//https://codeforces.com/blog/entry/18842?#comment-237886
	//https://codeforces.com/blog/entry/18842?#comment-237928	//Imp
	//https://codeforces.com/blog/entry/18842?#comment-237964 	//proper dp approach
	//https://codeforces.com/blog/entry/18842?#comment-237986
	//https://codeforces.com/blog/entry/18842?#comment-238030 	//probability
	ll k;
	cin>>k;
	ll c[k+1];
	for(int i=1;i<=k;i++){
	...
	ll n=0;
	for(int i=1;i<=k;i++){
		ll x=ncr(n+c[i]-1,c[i]-1,MOD);
		dp[i]=modmul(x,dp[i-1],MOD);
		n+=c[i];
	}
	cout<<dp[k];
	...
	1) 1 : 1
	2) {1 <-> 2},2 : 1*2c1=2
	3) {1,2,2 <-> 3,3},3 : 2*5c2=20
	4) {1,2,2,3,3,3 <-> 4,4,4},4 : 20*9c3= 1680
	*/
}
int main(){
	start();
