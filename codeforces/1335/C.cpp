...
void solve(LL tc)
{
	...
	LL ch_1=min(sz(m)-1,cnt);	//When element of 2nd team not present in team 1
	LL ch_2=min(sz(m),cnt-1);	//When team1 contains all elements of the array
	cout<<max(ch_1,ch_2)<<endl;
