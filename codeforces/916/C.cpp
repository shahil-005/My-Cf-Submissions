...
void solve(int tc)
{
	...
	//Make a tree with min path weights, such that path sum of the tree is prime
	//Both shortest path weight and MST will be equal to path sum of the tree
	//if m>n-1, create more edges bw non-consecutive nodes
}
int main(){
	start();
	time__("solve"){
