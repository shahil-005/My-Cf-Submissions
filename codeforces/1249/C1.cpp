...
// Problem : C1. Good Numbers (easy version)
// Contest : Codeforces - Codeforces Round #595 (Div. 3)
// URL : https://codeforces.com/contest/1249/problem/C1
// Memory Limit : 256 MB
// Time Limit : 1000 ms
...
void distSumRec(LL arr[],LL n,LL sum, 
                LL currindex,set<LL> &s) 
{ 
    if (currindex > n) 
        return; 
...
void solve()
{
	...
	LL x=10;
	set<LL> s; 
    	distSumRec(a, x, 0, 0, s); 
    	//for (auto i=s.begin(); i!=s.end(); i++){cout << *i << " ";}
        //cout<<endl;
        for (auto i=s.begin(); i!=s.end(); i++){
        	LL x=*i;
        	if(x>=n){cout<<x<<endl;break;}
        }
