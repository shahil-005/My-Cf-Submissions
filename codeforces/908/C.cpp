// Author: shahil_005
// Time: 2021-04-15 17:36:29
// Problem: C. New Year and Curling
// Contest: Codeforces - Good Bye 2017
// URL: https://codeforces.com/contest/908/problem/C
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
void solve(int tc)
{
	//My earlier mistake (Imp): https://codeforces.com/blog/entry/56691?#comment-404037
		
	ll n;cin>>n;
	ld r;cin>>r;
	ld a[n+1];for(int i=1;i<=n;i++) cin>>a[i];
