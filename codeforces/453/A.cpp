...
{
	//Edi sol
	// Approach : https://codeforces.com/blog/entry/13190?#comment-180832
	ll m,n;
	cin>>m>>n;
	ld ans=0;
	for(ll i=1;i<=m;i++){
		ld a=n,b=i,c=m;
		ans+=(pow((b/c),a)-pow((b-1)/c,a))*b;
	}
	cout<<fix(ans,15);
