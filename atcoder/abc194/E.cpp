...
const long long N=(long long)(2e6+1);
const long long N2=(long long)(6e6+1);
...
// }
// ll query(ll s,ll e,ll i,ll x,ll y){
	// if(x<=s && e<=y){
		// return tree[i];
	// }
	// if(y<s || x>e){
	...
	// }
	// ll mid=(s+e)/2;
	// ll left=query(s,mid,2*i,x,y);
	// ll right=query(mid+1,e,(2*i)+1,x,y);
